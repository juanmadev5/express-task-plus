...
export default function Register() {
    ...
    const handleRegister = async () => {
        ...
        if (success) {
            ...
            setErrorMessage("No se pudo crear la cuenta. Por favor intenta de nuevo.");
        }
    };
    ...
    return (
        <div className="font-comfortaa w-screen min-h-screen p-5 flex flex-col items-center justify-center bg-slate-900">
            ...
            <button
                ...
                className={`w-80 text-white mt-8 p-3 rounded-lg transition duration-150 ${isFormValid() ? "bg-cyan-500 hover:bg-cyan-600" : "bg-gray-400"
                    }`}
